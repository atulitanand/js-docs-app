...
class JSandJava extends React.Component {
  render() {
    return (
      /* jslint ignore: start */
      <>
        <div id="javascript-and-java">
          <h1 className="main-heading">JavaScript and Java</h1>
          <div className="content">
            <p>
              JavaScript and Java are similar in some ways but fundamentally
              different in some others. The JavaScript language resembles Java
              but does not have Java{`'`}s static typing and strong type
              checking. JavaScript follows most Java expression syntax, naming
